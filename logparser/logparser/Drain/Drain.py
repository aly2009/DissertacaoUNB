...
class LogParser:
    def __init__(self, log_format, indir='./', outdir='./result/', depth=4, st=0.5, 
    ...
    def parse(self, logName):
        ...
        for idx, line in self.df_log.iterrows():
            ...
            ''' Código desabilitado para não mostrar o progresso
            count += 1
    ...
    def log_to_dataframe(self, log_file, regex, headers, logformat):
        ...
        log_messages = []
        linecount = 0
        #with open(log_file, 'r', encoding='utf-8') as fin: #old ok para o bgl e ccmeval
